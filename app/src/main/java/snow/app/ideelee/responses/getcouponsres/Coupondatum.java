...
public class Coupondatum {
     ...
     * @param banner
     */
    public Coupondatum(String id, String serviceProviderId, String categoryId, String layoutType, String logo, String endDate, Object image, String voucherOfferPrice, String voucherText, String termConditions, String price, String banner, String status, String createdAt) {
        super();
        this.id = id;
