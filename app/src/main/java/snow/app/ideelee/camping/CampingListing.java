  ...
  (R.id.recyclerView) RecyclerView recyclerView;
   ...
   @BindView(R.id.img) ImageView img;
    @BindView(R.id.relevance) TextView relevance ;
      ...
      @BindView(R.id.title_bookingappointement) TextView     textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        textView.setText("Camping and Equipments For Rent");
...
//        Picasso.with(this).load("https://www.training.com.au/wp-content/uploads/plumbing-courses.png").resize(width,width/2).into(img);
        ...
        CampinglistingAdapter adapter = new CampinglistingAdapter(CampingListing.this, serviceproviderlist);
        ...
        relevance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(CampingListing.this, relevance);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        Toast.makeText(CampingListing.this, "You Clicked : " + item.getTitle(), Toast.LENGTH_SHORT).show();
                        return true;
                    }
                });
