...
public class ElectricBookingPerDay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electric_bookingperday);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ElectricBookingPerDay.this, ElectricBookingRequirements.class);
    ...
    public void confirmbooking() {
        ...
        btn_continue_loginPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ElectricBookingPerDay.this, RentalBookingActivity.class);
