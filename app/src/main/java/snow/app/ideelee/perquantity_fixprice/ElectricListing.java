...
public class ElectricListing extends Activity {

    List<ServiceProviderList> serviceproviderlist;
    TagGroup mTagGroup;
    RecyclerView recyclerView;

    public ElectricListing() {
    }
...
//        Picasso.with(this).load("https://www.training.com.au/wp-content/uploads/plumbing-courses.png").resize(width,width/2).into(img);
        ...
        ElectricworklistingAdapter adapter = new ElectricworklistingAdapter(this, serviceproviderlist);
        ...
        relevance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(ElectricListing.this, relevance);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        Toast.makeText(ElectricListing.this, "You Clicked : " + item.getTitle(), Toast.LENGTH_SHORT).show();
                        return true;
                    }
                });
