package snow.app.ideelee.perhour_fixpricemodule.adapters;
...
public class TeachingSubCatAdapter extends RecyclerView.Adapter<TeachingSubCatAdapter.ProductViewHolder> {
    ...
    public TeachingSubCatAdapter(Context mCtx, List<ServiceProviderList> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public TeachingSubCatAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        final View view = inflater.inflate(R.layout.teaching_subcat_row, null);
...
//                Intent intent=new Intent(mCtx, BookingAppointment.class);
        ...
        return new TeachingSubCatAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(TeachingSubCatAdapter.ProductViewHolder holder, int position) {
    ...
    public void perHourPopup(View v) {
        ...
        btn_continue_loginPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mCtx, TeachingBookingAppointment.class);
