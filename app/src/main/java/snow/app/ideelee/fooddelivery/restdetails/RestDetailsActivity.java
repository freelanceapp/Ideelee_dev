...
public class RestDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title_=(TextView) findViewById(R.id.title_bookingappointement);
        menu=(TextView) findViewById(R.id.menu);
        lunch_rv=(RecyclerView)findViewById(R.id.lunch_rv);
        breakfast_rv=(RecyclerView)findViewById(R.id.breakfast_rv);
