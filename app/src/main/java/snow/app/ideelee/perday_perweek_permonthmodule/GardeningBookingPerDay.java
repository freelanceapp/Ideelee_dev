...
public class GardeningBookingPerDay extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GardeningBookingPerDay.this, GardeningBookingActivity.class);
    ...
    public void confirmbooking() {
        ...
        btn_continue_loginPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GardeningBookingPerDay.this, RentalBookingActivity.class);
