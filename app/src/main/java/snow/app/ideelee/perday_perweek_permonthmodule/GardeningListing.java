...
import snow.app.ideelee.perday_perweek_permonthmodule.adapters.GardeninglistingAdapter;


public class GardeningListing extends Activity {

    List<ServiceProviderList> serviceproviderlist;
    TagGroup mTagGroup;
    RecyclerView recyclerView;

    public GardeningListing() {
    }
...
//        Picasso.with(this).load("https://www.training.com.au/wp-content/uploads/plumbing-courses.png").resize(width,width/2).into(img);
        ...
        GardeninglistingAdapter adapter = new GardeninglistingAdapter(GardeningListing.this, serviceproviderlist);
        ...
        relevance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(GardeningListing.this, relevance);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        Toast.makeText(GardeningListing.this, "You Clicked : " + item.getTitle(), Toast.LENGTH_SHORT).show();
                        return true;
                    }
                });
