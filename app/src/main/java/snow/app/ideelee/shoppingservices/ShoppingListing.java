...
public class ShoppingListing extends Activity {
...
//        setSupportActionBar(toolbar);
        ...
        textView.setText("Shopping and Delivery Services");
...
//        Picasso.with(this).load("https://www.training.com.au/wp-content/uploads/plumbing-courses.png").resize(width,width/2).into(img);
        ...
        ShoppingListAdapter adapter = new ShoppingListAdapter(this, serviceproviderlist);
