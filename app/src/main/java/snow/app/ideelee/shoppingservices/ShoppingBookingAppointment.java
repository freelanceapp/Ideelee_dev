...
public class ShoppingBookingAppointment extends Activity {
    TagGroup mTagGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shooping_booking_appointment);
...
//    });
    ...
    public void confirmbooking() {
        ...
        btn_continue_loginPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShoppingBookingAppointment.this, ShoppingBookingActivity.class);
