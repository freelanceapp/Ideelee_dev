...
public class RentalBookingPerDay extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rental_booking_appointment);
        ButterKnife.bind(this);

        textView.setText("Rental Services");
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RentalBookingPerDay.this, RentalBookingActivity.class);
