...
public class VehicleWashSubCat extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vehicalwashsubcat);
        ButterKnife.bind(this);
        textView.setText("Vehicle Wash");
...
//        Picasso.with(this).load("https://www.training.com.au/wp-content/uploads/plumbing-courses.png").resize(width,width/2).into(img);
        ...
        VehicleWashSubCatAdapter adapter = new VehicleWashSubCatAdapter(this, serviceproviderlist);
        ...
        relevance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(VehicleWashSubCat.this, relevance);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        Toast.makeText(VehicleWashSubCat.this, "You Clicked : " + item.getTitle(), Toast.LENGTH_SHORT).show();
                        return true;
                    }
                });
